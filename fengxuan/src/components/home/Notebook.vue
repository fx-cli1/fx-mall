...
<van-nav-bar title="购物车" left-text="返回" left-arrow>
  ...
  <div class="note">
   ...
   <ul class="note-di2">
     <li><img src="https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/0d1ffaea355ab590ee88a48c9ab1ef0f.jpg?f=webp" alt="">
      <li><img src="https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/d4e381d6664a0f4aa94984af7b676de5.jpg?f=webp" alt=""></li>
      <li><img src="https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/400e740d63fe4f377b05a3c969f150bf.jpg?f=webp" alt=""></li>
      <li><img src="https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/1a1a44f1b6a7ed090eb624969845bd7e.jpg?f=webp" alt=""></li>
      <li><img src="https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/8cd3044325d320007ec3c3444396287d.jpg?f=webp" alt=""></li>
      <li><img src="https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/21d72b6e96625e586e52ac3e6b0bfedc.jpg?f=webp" alt=""></li>
   </ul>
  </div>
  </div>
</template>
...
.note-top > img {
  ...
  height: 100%;
  margin: 25px 0;
  /* border: 1px solid rgb(72, 120, 165); */
}
.note-center {
  width:100%;
  height: 650px;
